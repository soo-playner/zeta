...
if(isset($config['cf_theme']) && trim($config['cf_theme'])) {
    ...
    if(is_dir($theme_path)) {
		...
		define('G5_THEME_PATH_FILE',        $theme_path."/".basename($_SERVER['PHP_SELF']));
		define('G5_WALLET_PATH',       G5_URL."/wallet/");
        ...
        define('G5_THEME_CSS_URL',     G5_THEME_URL.'/_common/'.G5_CSS_DIR);
        define('G5_THEME_IMG_URL',     G5_THEME_URL.'/'.G5_IMG_DIR);
        define('G5_THEME_JS_URL',      G5_THEME_URL.'/_common/'.G5_JS_DIR);
    }
    unset($theme_path);
}
