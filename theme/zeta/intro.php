...
.container {
	...
	display:block;
	height:100vh;
	background:#000 url('<?=G5_THEME_URL?>/img/launcher.png?at=123456') no-repeat center;
...
<div class="container">
	...
	<div class='intro_title'>
		<p class='company' style="line-height:16px;color:#6a6306"> 제타랩스 주식회사 | 사업자등록번호 356-87-02523 <br>통신판매업 신고번호 : 제 2022-서울강남-00711호<br>고객센터 : 02-6205-1112 | 이메일 : <?=$config['cf_admin_email']?></p>
